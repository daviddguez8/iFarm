...
export default function SignUp() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const wasCreated = await createAccount(name, email, password, username);
    if (wasCreated) {
        navigate('/login');
    }
    else {
        ...
        <Container className="login-card">
          ...
          <Row className="" style={{width:"100%"}}>
            <Form onSubmit={(e)=>{handleSubmit(e)}}>
              <Form.Group className="mb-3">
                ...
                >
                  <Form.Control 
                    ...
                    className="bg-transparent green-border text-white"
              ...
              <Button className="bg-transparent text-white green-border" variant="primary" type="submit">
                  Submit
                </Button>  
            </Form>
          ...
          <Row className="centered">
            ...
            <Row className="mb-1 centered">
              <p>Or sign up using the following:</p>
            </Row>

            <Row className="centered">
              <Col>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" className="bi bi-google" viewBox="0 0 16 16">
          ...
          <Row>
            <p>Already have an account? <Link to="/login" style={{color: "green"}}>Sign in here</Link></p>
          </Row>
